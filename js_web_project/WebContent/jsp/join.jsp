		...
		<section class="join">
			...
			<form name="joinForm" action="07_joinCheck.jsp" method="post">
				<ul>
					...
					<li>
						<label>비밀번호</label>
						<input type="password" name="pass" placeholder="8자 이상 영문(대소문자 구분), 특수문자 포함"  class="input1" id= "pass">
					</li>
					<li>
						<label>비밀번호 확인</label>
						<input type="password" name="cpass" placeholder="8자 이상 영문(대소문자 구분), 특수문자 포함"  class="input1" id= "cpass">
						<span id= "cmsg"></span>
					</li>
					<li>
						<label>이름</label>
