...
<script>
	$(document).ready(function(){
		...
		$("#set_data").click(function(){
			...
			// document.getElementById("name").value = "홍길동"; --> $("#name").val();
			$("#name").val("홍길동");
			
			// 2. innerHTML --> text()
			$("#addr").text("서울시 강남구");
			
			// 3. text에 html 태그를 추가하는 경우 --> html()
...
<body>
	...
	네이버 주소 가져오기(href 속성) : <span id= "s1"></span><br>
	이미지 주소 가져오기(src 속성) : <span id= "s2"></span><br>
